...
local show_dialog = function()
  renoise.app():show_custom_dialog("cLib unit-tests", view)
end
...
local initialize = function()
  ...
  for __, filename in pairs(os.filenames(_clibroot.."unit_tests")) do
    ...
    if (extension == "lua") then
      ...
      require (_clibroot.."unit_tests/"..fname)
    end
  end

  print(">>> __tests...",rprint(__tests))
