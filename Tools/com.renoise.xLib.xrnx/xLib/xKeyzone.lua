...
function xKeyzone.shift_keyzone_by_semitones(instr,sample_idx_from,amt)
  --TRACE("xKeyzone.shift_keyzone_by_semitones(instr,sample_idx_from,amt)",instr,sample_idx_from,amt)
