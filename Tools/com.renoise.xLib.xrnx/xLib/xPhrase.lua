...
function xPhrase.replace_sample_index_in_phrase(phrase,idx_from,idx_to)
  --TRACE("xPhrase.replace_sample_index_in_phrase(phrase,idx_from,idx_to)",phrase,idx_from,idx_to)
