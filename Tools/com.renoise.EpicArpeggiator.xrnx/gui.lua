...
--------------------------------------------------------------------------]]
      ...
      distance_row_contents:add_child(
         create_obj(obj_valuebox, '', 50,0,MAX_PATTERN_LINES,distance_step,'vbox_distance_step',
      ...
      termination_row_contents:add_child(
         create_obj(obj_valuebox, '', 50,0,MAX_PATTERN_LINES,termination_step,'vbox_termination_step',
      ...
      --Arpeggiation pattern plus note columns plus chord mode
                  ...
                  vb:column{
                     ...
                     vb:row {
                        ...
                        vb:horizontal_aligner {
                           ...
                           create_obj(obj_valuebox, '', 51,1,MAX_NOTE_COLUMNS,max_note_columns,
                           'max_note_colums',
      ...
      -- Instrument and velocity fields
      local property_area = vb:column {
         ...
         vb:column {
            ...
            vb:row {
               ...
               'popup_ins_insertion',
               'How should instrument numbers be inserted from the pool?',
               {"TopDown", "DownTop", "TopDownTop","DownTopDown", "Random"},
            ...
            vb:row{
               ...
               'popup_vel_insertion',
               'How should velocity layers be inserted from the pool?',
               {"TopDown", "DownTop", "TopDownTop","DownTopDown", "Random"},
         ...
         -- Area of operation selection and execution-options
         vb:row {
