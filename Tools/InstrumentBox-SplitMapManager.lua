...
name = "InstrumentBox:Split map manager",
description = "Change splitmappings of current instrument",
invoke = function() 
...
function open_splitmap_dialog()
   ...
   if not (splitmap_dialog and splitmap_dialog.visible) then
      ...
      ss_field_function, ss_function, ss_field_id, ss_string,ss_start,ss_end)
         return vb:row{
            create_obj(obj_textlabel,'', TEXT_ROW_WIDTH,0,0,0,ss_text_id,'',
            ss_text,0,vb),
            create_obj(obj_minislider,'',60,ss_start,ss_end,ss_value,ss_id,
            '',0,ss_function,vb),
            create_obj(obj_textfield, '', 32,0,0,ss_string,ss_field_id,'',0,
      ...
      vb:column {
         ...
         vb:column{
            ...
            vb:horizontal_aligner {
               mode = "center",
               vb:row {
                  create_obj(obj_textlabel, '', 80,0,0,0,'semitone_division_text',
                  '','Each sample should be mapped to',0,vb),
                  create_obj(obj_valuebox, '', 52,1,120,semi_tone_division,
                  'semi_tone_division_value','',0,
                  function(value)semi_tone_division = value end,vb),
                  create_obj(obj_textlabel, '', 42,0,0,0,'semitone_division_post_text',
                  '','semitones',0,vb),
               },
            },
            vb:horizontal_aligner {
               mode = "center",
               vb:row {
                  create_obj(obj_checkbox, '', 18,0,0,sample_trail_start,
                  'trail_sample_start','',0,
                  function(value)sample_trail_start = value end,vb),
                  create_obj(obj_textlabel, '', 42,0,0,0,'trail_sample_start_text',
            ...
            vb:horizontal_aligner {
               mode = "center",
               vb:row {
                  create_obj(obj_checkbox, '', 18,0,0,sample_trail_end,
                  'trail_sample_end','',0,
                  function(value)sample_trail_end = value end,vb),
                  create_obj(obj_textlabel, '', 42,0,0,0,'trail_sample_end_text',
            ...
            vb:horizontal_aligner {
               mode = "center",
               vb:row {
                  create_obj(obj_button, '', 60,0,0,0,'idb1','',
         ...
         vb:column{
            ...
            spacing = 3,
            vb:row{
               create_obj(obj_textlabel, 'center', 330,0,0,0,
            ...
            vb:horizontal_aligner {
               mode = "center",
               vb:row{
                  create_obj(obj_valuebox, '', 52,-120,120,tonumber(split_range),
