...
local function copy_effect_column(src_column, dest_column)
...
local function copy_note_column(src_column, dest_column)
...
local function copy_line(src_line, dest_line)
...
local function selection_line_range(pattern_index)
...
-- rotate:
-- current pattern by the given amount in the given range
...
function rotate(shift_amount, range_mode, shift_automation)
  ...
  for pattern_index = pattern_start,pattern_end do
    ...
    for track_index = track_start,track_end do
      ...
      -- rotate automation but (not for pattern selections)
