...
function vColor.adjust_brightness(rgb,amt)
  ...
  local hsv = vColor.rgb_to_hsv(rgb)
  if (amt > 0.5) then
...
function vColor.color_table_to_value(t)
...
function vColor.color_table_to_hex_string(t)

  local val = vColor.color_table_to_value(t)
  return vColor.value_to_hex_string(val)
...
function vColor.value_to_color_table(val)
...
function vColor.value_to_hex_string(val)
...
function vColor.rgb_to_hsv(rgb)
...
function vColor.hsv_to_rgb(hsv)
