...
function xNoteColumn:__init(args)
  ...
  --print("*** args.note_value",args.note_value)
...
function xNoteColumn:__tostring()
  --print("xNoteColumn:__tostring - ",note_string,instrument_string,volume_string,panning_string,delay_string)
  return note_string..instrument_string..volume_string..panning_string..delay_string
