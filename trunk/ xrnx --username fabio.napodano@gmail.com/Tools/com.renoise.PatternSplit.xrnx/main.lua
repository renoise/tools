  ...
  for num_track = 1, num_tracks do
    ...
    for num_auto = 1, table.getn(new_pattern.tracks[num_track].automation) do
      ...
      then
        ...
        new_pattern.tracks[num_track].automation[num_auto]:add_point_at(current_line+1,points[current_line].value)
	...
	renoise.app():show_warning(tostring(auto_time) .. ', ' .. tostring(auto_value));
