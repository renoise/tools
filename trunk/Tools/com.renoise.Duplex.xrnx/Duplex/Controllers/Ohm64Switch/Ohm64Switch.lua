...
Inheritance: Ohm64Switch > MidiDevice > Device
...
class "Ohm64Switch" (MidiDevice)

function Ohm64Switch:__init(display_name, message_stream, port_in, port_out)
    TRACE("Ohm64Switch:__init", display_name, message_stream, port_in, port_out)
...
function Ohm64Switch:point_to_value(pt,elm,ceiling)
...
-- setup Mixer + Matrix + Effect + SwitchConfiguration as apps - 
...
duplex_configurations:insert {
    ...
    -- device properties
    device = {
        class_name = "Ohm64Switch",          
        display_name = "Ohm64Switch",
        device_port_in = "Ohm64 MIDI 1",
        device_port_out = "Ohm64 MIDI 1",
        control_map = "Controllers/Ohm64Switch/Ohm64Switch.xml",
        thumbnail = "Ohm64Switch.bmp",
...
--------------------------------------------------------------------------------
-- setup Mixer + Step sequencer + Navigator + Effects + SwitchConfiguration 
-- as apps - 
