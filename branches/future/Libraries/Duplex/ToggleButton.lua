...
module("ToggleButton", package.seeall);
...
function ToggleButton:add_listeners()
	...
	self.display.device.message_stream:add_listener(self,DEVICE_EVENT_BUTTON_PRESSED,function() self.do_press(self) end )
	self.display.device.message_stream:add_listener(self,DEVICE_EVENT_VALUE_CHANGED,function() self.do_change(self) end )
